...
export default function ProductCard({
  ...
  return (
    <div className="rounded-xl bg-white dark:bg-neutral-700 hover:bg-blue-50 dark:hover:bg-neutral-800 hover:ring-2 hover:ring-blue-200 dark:hover:ring-neutral-700 p-4 shadow mb-4">
      <ProductImage />
